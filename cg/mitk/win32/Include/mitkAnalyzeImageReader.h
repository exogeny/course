...
#ifndef __mitkAnalyzeImageReader_h
#define __mitkAnalyzeImageReader_h
...
// ******************************** Definition of Analyze Header File ***************************************

namespace AnalyzeImageIO
{
/**
...
typedef enum 
{
    ANALYZE_ORIENTATION_RPI_TRANSVERSE=0,        /**< Denotes a transverse data orientation Right-->Left, */
    ANALYZE_ORIENTATION_RIP_CORONAL   =1,        /**< Denotes a coronal data orientation */
    ANALYZE_ORIENTATION_PIR_SAGITTAL  =2,        /**< Denotes a sagittal data orientation */
    ANALYZE_ORIENTATION_RAI_TRANSVERSE_FLIPPED=3,/**<  */
    ANALYZE_ORIENTATION_RSP_CORONAL_FLIPPED=4,   /**<  */
    ANALYZE_ORIENTATION_PIL_SAGITTAL_FLIPPED=5   /**<  */
...
using namespace AnalyzeImageIO;
...
///          file will only read the first 348 bytes into the structure defined in this file, and all informaiton beyond the
///          348 bytes will be ignored.
class MITK_COMMON_API mitkAnalyzeImageReader : public mitkVolumeReader
{
public:
    MITK_TYPE(mitkAnalyzeImageReader, mitkVolumeReader)
    ...
    const char * GetFileExtensions() { return ".hdr .img .img.gz"; }

protected:
    virtual ~mitkAnalyzeImageReader();
    ...
    ByteOrder CheckAnalyzeEndian(const struct dsr &temphdr);
...
private:
    mitkAnalyzeImageReader(const mitkAnalyzeImageReader&);
    void operator = (const mitkAnalyzeImageReader&);

    ByteOrder       m_ByteOrder;
    FileType        m_FileType;

    struct dsr      m_Hdr;
    ByteOrder       m_MachineByteOrder;
};
