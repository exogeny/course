...
本次作业使用了[libwb](https://github.com/abduld/libwb)的开源库。
...
include(Convolution/sources.cmake)
include(ImageBlur/sources.cmake)
...
``` text
-rw-rw-r--  1 wangteng wangteng   20448 7月  12 16:57 CMakeCache.txt
drwxrwxr-x 11 wangteng wangteng    4096 7月  12 16:57 CMakeFiles
-rw-rw-r--  1 wangteng wangteng    1419 7月  12 16:57 cmake_install.cmake
-rwxrwxr-x  1 wangteng wangteng  825416 7月  12 16:57 Convolution_DatasetGenerator
-rwxrwxr-x  1 wangteng wangteng 1495560 7月  12 16:57 Convolution_Solution
-rwxrwxr-x  1 wangteng wangteng   54544 7月  12 16:57 ImageBlur_DatasetGenerator
-rwxrwxr-x  1 wangteng wangteng 1481608 7月  12 16:57 ImageBlur_Solution
-rw-rw-r--  1 wangteng wangteng 2058424 7月  12 16:57 libwb.a
-rw-rw-r--  1 wangteng wangteng   26872 7月  12 16:57 Makefile
-rwxrwxr-x  1 wangteng wangteng   54608 7月  12 16:57 TiledMatrixMultiplication_DatasetGenerator
-rwxrwxr-x  1 wangteng wangteng 1501216 7月  12 16:57 TiledMatrixMultiplication_Solution
```

**代码运行：**

先使用`*_DatasetGenerator`产生测试数据，之后使用`*_Solution`进行测试：

``` bash
./TiledMatrixMultiplication_Solution \
  -e TiledMatrixMultiplication/Dataset/0/output.raw \
  -i TiledMatrixMultiplication/Dataset/0/input0.raw,\
  TiledMatrixMultiplication/Dataset/0/input1.raw \
  -t matrix
```
